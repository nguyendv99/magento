<?php
namespace Lof\ChatSystem\Model\TransportBuilder;

/**
 * Interceptor class for @see \Lof\ChatSystem\Model\TransportBuilder
 */
class Interceptor extends \Lof\ChatSystem\Model\TransportBuilder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMessageContent');
        if (!$pluginInfo) {
            return parent::getMessageContent();
        } else {
            return $this->___callPlugins('getMessageContent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMessageSubject');
        if (!$pluginInfo) {
            return parent::getMessageSubject();
        } else {
            return $this->___callPlugins('getMessageSubject', func_get_args(), $pluginInfo);
        }
    }
